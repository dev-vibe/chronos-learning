...
if (await page.locator('.card-class', { hasText: 'Place' }).count() !== 1) throw new Error('Completed card missing Place type badge.');
...
if (await page.locator('.card-class', { hasText: 'Place' }).count() !== 1) throw new Error('Revisit showed a duplicate or missing Place type.');
if (await page.getByText('In your Knowledge Cards').count() !== 1) throw new Error('Revisit did not keep the owned card view.');
