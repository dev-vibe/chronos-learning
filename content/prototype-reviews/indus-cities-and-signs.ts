...
export const indusPrototypeReview: LessonPrototypeReview = {
  ...
  productReview: { state: 'pending', reviewedBy: 'Carlin Aylsworth', reviewedOn: '2026-09-12', notes: 'Carlin approved the text-first prototype with “lgtm” after the independent-review service limit was disclosed, then requested a stronger visual direction because the images were boring. The revised neighborhood and reservoir reconstructions now await his look. Text, claims, prompts and sincere-attempt completion remain approved; publication is not authorized.' },
};
