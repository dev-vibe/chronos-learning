...
export const urukLesson: Lesson = {
    ...
    sections: [
      ...
      { id: 'section.uruk.masthead', heading: 'Uruk around 3200 BCE', purpose: 'Begin with place and scale', modules: [{ id: 'module.uruk.city-glance', type: 'prose', body: 'Uruk grew into a major city in southern Mesopotamia. Food, work, worship, and record-keeping had to be organized at a new scale.', claimIds: ['claim.uruk.city-life'], sourceIds: ['source.met.uruk'] }, {
