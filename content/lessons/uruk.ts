...
export const urukPrompts: UnderstandingPrompt[] = [
  ...
  { id: 'prompt.uruk.opportunity-and-cost', lessonId: 'lesson.uruk.first-city', kind: 'concise-explanation', question: 'Name one opportunity and one cost or challenge of life in Uruk, using lesson evidence.', explanation: 'A sincere answer pairs an opportunity such as specialized work with a challenge such as coordinated labor, inequality, crowding, or pressure on resources.', required: true, minimumResponseLength: 20 }
];
...
export const urukLesson: Lesson = {
    ...
    status: 'published', place: 'Southern Mesopotamia', heroMediaId: 'media.uruk.reconstruction', heroLabel: 'Evidence-based reconstruction', heroCaption: 'A reconstructed view of early Uruk based on archaeological evidence — not a photograph of the past.',
