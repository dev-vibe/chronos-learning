...
export const farmingSettlementsMedia: MediaAsset[] = [
  ...
  },
  {
    ...
    alt: 'Illustrated locator map of Anatolia showing Çatalhöyük on the Konya plain of the Anatolian Plateau between the Mediterranean Sea and the Black Sea',
    depictionMode: 'map',
    depictionLabel: 'Illustrative historical locator map · modern coasts for orientation',
    ...
    visualBriefRef: 'docs/research/farming-catalhoyuk-locator-map.md',
    reviewStatus: 'approved',
  },
];
...
export const farmingSettlementsLesson: Lesson = {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          title: 'An inland settlement on the Konya plain',
          body: 'Çatalhöyük stands inland on the Konya plain of the Anatolian Plateau. The map places this Southwest Asian case between the Mediterranean and Black Seas. It does not draw a worldwide origin of farming.',
          ...
          compactLabel: 'Illustrative map · modern coasts for orientation',
  ...
  mediaIds: ['media.farming.catalhoyuk-house-diagram', 'media.farming.catalhoyuk-locator-map'],
  promptIds: [
