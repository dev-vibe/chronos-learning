...
select throws_ok(
  $$select public.complete_lesson_and_acquire_card('lesson.writing.early-systems','test-unpublished-lesson')$$,
...
select throws_ok(
 $$select public.complete_lesson_and_acquire_card('lesson.writing.early-systems','test-success-command')$$,
