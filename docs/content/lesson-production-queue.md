...
Status lives only in the table below and in each lesson's PR. Do not add dated narrative paragraphs here.
...
7. Create a per-lesson Linear issue only when the row becomes active (if one does not already exist). Linear follows the branch and PR through the issue key; do not update it by hand.
8. The row changes twice, both in the lesson's own PR: `Active` in its first commit and `Complete` in its last.
...
| `Active` | The lesson is in production on its branch and PR. Where it stands (research checkpoint, prototype, publication) is visible in the PR. |
...
| 15 | `lesson.humans.sahul-crossing` — Crossing to Sahul | 3 | Product-owner direction (2026-09-03): backfill first-era World Spine position 3 in parallel with Pyramids, Builders, and Evidence. | Satisfied | `Complete` | [ASH-109](https://linear.app/ashs-workshop/issue/ASH-109/research-and-publish-crossing-to-sahul) · [PR #35 merged](https://github.com/dev-vibe/chronos-learning/pull/35) |
...
| 70 | `lesson.egypt.pyramids-and-state-labor` — Pyramids, Builders, and Evidence | 15 | Teach how context, phase, date, attribution, use, and purpose differ, using Giza plus concise Osirion, Hawara, and stone-vessel comparisons. | Satisfied | `Complete` | [ASH-99](https://linear.app/ashs-workshop/issue/ASH-99/research-and-publish-pyramids-builders-and-evidence) · [PR #29 merged](https://github.com/dev-vibe/chronos-learning/pull/29) |
| 80 | `lesson.indus.cities-and-signs` — Indus Cities and Undeciphered Signs | 16 | Add a major independent urban tradition and teach disciplined inference from archaeology when writing cannot be read. | Early Writing Systems merged and verified; parallel production explicitly authorized by Carlin September 9, 2026 | `Complete` | [ASH-100](https://linear.app/ashs-workshop/issue/ASH-100/research-and-publish-indus-cities-and-undeciphered-signs) · [PR #41 merged](https://github.com/dev-vibe/chronos-learning/pull/41) |
| 90 | `lesson.nubia.kerma-and-nile-world` — Kerma and the Middle Nile | 17 | Explain the Nile as a connected political world rather than an Egypt-only story. | Satisfied | `Complete` | [ASH-101](https://linear.app/ashs-workshop/issue/ASH-101/research-and-publish-kerma-and-the-middle-nile) · [PR #47 merged](https://github.com/dev-vibe/chronos-learning/pull/47) · [Live lesson](https://chronos-learning.vercel.app/learn/lesson.nubia.kerma-and-nile-world) · [Research record](../research/kerma-and-middle-nile.md) |
| 100 | `lesson.mesopotamia.akkadian-empire` — Akkad and the Problem of Empire | 18 | Introduce empire as a recurring political strategy rather than a celebratory first. | Early Writing Systems merged and verified | `Complete` | [ASH-102](https://linear.app/ashs-workshop/issue/ASH-102/research-and-publish-akkad-and-the-problem-of-empire) · [PR #49 merged](https://github.com/dev-vibe/chronos-learning/pull/49) · [Research record](../research/akkad-and-the-problem-of-empire.md) |
...
- [ ] Linear issue and PR are linked when they exist.
