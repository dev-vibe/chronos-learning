...
`lesson.egypt.nile-state` is the single active row. It entered research on August 16, 2026 under ASH-97 after Many Beginnings of Farming completed publication. Caral remains approved and ready, with its stated production dependency; Planned rows require explicit promotion before selection.
