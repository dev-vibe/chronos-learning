...
`lesson.egypt.nile-state` is the single active row. Its Stages 0–14B packet and independent adult learner-proxy review completed on August 16, 2026 with no blocking findings; product-owner approval is pending. Caral remains approved and ready, with its stated production dependency; Planned rows require explicit promotion before selection.
