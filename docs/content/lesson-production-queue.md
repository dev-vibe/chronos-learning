...
| 70 | `lesson.egypt.pyramids-and-state-labor` — Pyramids, Power, and State Labor | 15 | Teach how an early state mobilized skilled labor and resources for monumental building, using Old Kingdom evidence rather than pyramid myths. | Nile lesson merged and verified | `Awaiting approval` | [ASH-99](https://linear.app/ashs-workshop/issue/ASH-99/research-and-publish-pyramids-power-and-state-labor) · [Draft PR #29](https://github.com/dev-vibe/chronos-learning/pull/29) |
