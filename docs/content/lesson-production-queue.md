...
| 70 | `lesson.egypt.pyramids-and-state-labor` — Pyramids, Power, and State Labor | 15 | Teach the strongest evidence for pyramid chronology, attribution, labor, and purpose while making construction phases, reuse, and unresolved questions explicit. | Nile lesson merged and verified; revised thesis and journey split require product approval | `Researching` | [ASH-99](https://linear.app/ashs-workshop/issue/ASH-99/research-and-publish-pyramids-power-and-state-labor) · [Draft PR #29](https://github.com/dev-vibe/chronos-learning/pull/29) |
