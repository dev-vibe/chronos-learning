...
| 90 | `lesson.nubia.kerma-and-nile-world` — Kerma and the Middle Nile | 17 | Explain the Nile as a connected political world rather than an Egypt-only story. | Nile lesson merged and verified; revised research direction approved September 14; learner prototype and adult review pending | `Researching` | [ASH-101](https://linear.app/ashs-workshop/issue/ASH-101/research-and-publish-kerma-and-the-middle-nile) · [Draft PR #47](https://github.com/dev-vibe/chronos-learning/pull/47) · [Research record](../research/kerma-and-middle-nile.md) |
...
On September 14, 2026, the next-lesson boot reconciled Sahul's stale `Review` label against merged PR #35, ASH-109 `Done`, and the [research record](../research/crossing-to-sahul.md#final-implementation-and-release-work) documenting the applied publication migration and verified media on September 4. This records existing release evidence, not a new hosted walkthrough. Kerma started from current main `308ad73` in `.worktrees/ash-101-kerma`, branch `codex/ash-101-kerma-and-middle-nile`. Its [research record](../research/kerma-and-middle-nile.md) owns the Stage 3B packet and pending owner response. Existing checkout changes remain untouched.

Later on September 14, Carlin approved Kerma's revised research direction after the audience-fit self-review. The same branch now contains the full six-section unpublished lesson and two working prompts, with planned map/object-photo annotations and a no-card ending. [Local learner prototype](http://localhost:3000/learn/lesson.nubia.kerma-and-nile-world) requires the running isolated-worktree preview server. The row remains `Researching` while the Stage 14B adult raw-lesson review is pending; author/automated review does not impersonate that human participation. Product review remains `pending`, and no final media, unlock or publication is approved by the research-direction response.
