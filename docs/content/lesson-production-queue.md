...
| 80 | `lesson.indus.cities-and-signs` — Indus Cities and Undeciphered Signs | 16 | Add a major independent urban tradition and teach disciplined inference from archaeology when writing cannot be read. | Early Writing Systems merged and verified; parallel production explicitly authorized by Carlin September 9, 2026 | `Researching` | [ASH-100](https://linear.app/ashs-workshop/issue/ASH-100/research-and-publish-indus-cities-and-undeciphered-signs) · [Draft PR #41](https://github.com/dev-vibe/chronos-learning/pull/41) · Typed prototype built September 11; independent review pending after reviewer service limit. |
