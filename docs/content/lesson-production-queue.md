...
| 15 | `lesson.humans.sahul-crossing` — Crossing to Sahul | 3 | Product-owner direction (2026-09-03): backfill first-era World Spine position 3 in parallel with Pyramids, Builders, and Evidence. | `lesson.humans.migrations-and-interbreeding` merged and verified | `Implementing` | [ASH-109](https://linear.app/ashs-workshop/issue/ASH-109/research-and-publish-crossing-to-sahul) · [PR #35 draft](https://github.com/dev-vibe/chronos-learning/pull/35) |
