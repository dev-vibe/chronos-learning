...
| 90 | `lesson.nubia.kerma-and-nile-world` — Kerma and the Middle Nile | 17 | Explain the Nile as a connected political world rather than an Egypt-only story. | Publication authorized; migration applied; 11 media objects verified; authenticated hosted smoke passed September 17; merge and production verification pending | `Review` | [ASH-101](https://linear.app/ashs-workshop/issue/ASH-101/research-and-publish-kerma-and-the-middle-nile) · [PR #47](https://github.com/dev-vibe/chronos-learning/pull/47) · [Research record](../research/kerma-and-middle-nile.md) |
...
The final branch deployment and PR checks are green. The delegated hosted smoke reached Vercel authentication on both direct and audit links before lesson content loaded; Carlin completed the supplied authenticated preview and completion/reopen checklist and reported “smoke is fine” on September 17. Keep the row in `Review` until merge and production deployment verification.
