...
| 15 | `lesson.humans.sahul-crossing` — Crossing to Sahul | 3 | Product-owner direction (2026-09-03): backfill first-era World Spine position 3 in parallel with Pyramids, Builders, and Evidence. | `lesson.humans.migrations-and-interbreeding` merged and verified | `Awaiting approval` | [ASH-109](https://linear.app/ashs-workshop/issue/ASH-109/research-and-publish-crossing-to-sahul) · [PR #35 draft](https://github.com/dev-vibe/chronos-learning/pull/35) |
...
| 70 | `lesson.egypt.pyramids-and-state-labor` — Pyramids, Power, and State Labor | 15 | Teach how an early state mobilized skilled labor and resources for monumental building, using Old Kingdom evidence rather than pyramid myths. | Nile lesson merged and verified | `Ready` | [ASH-99](https://linear.app/ashs-workshop/issue/ASH-99/research-and-publish-pyramids-power-and-state-labor) |
