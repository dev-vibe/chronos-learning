...
| 90 | `lesson.nubia.kerma-and-nile-world` — Kerma and the Middle Nile | 17 | Explain the Nile as a connected political world rather than an Egypt-only story. | Nile lesson merged and verified; Stages 0–3B research underway, owner research-direction response pending | `Researching` | [ASH-101](https://linear.app/ashs-workshop/issue/ASH-101/research-and-publish-kerma-and-the-middle-nile) · [Research record](../research/kerma-and-middle-nile.md) |
