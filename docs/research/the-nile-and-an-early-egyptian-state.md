...
| `source.egypt.met-narmer-sealing` | [The Met, Mud jar sealing with King Narmer’s name](https://www.metmuseum.org/art/collection/search/547443), accession 12.187.42 | Museum object record (Open Access API record read 2026-09-25) | Narmer’s name on a mud jar sealing, c. 3100 BCE, clay (mud), H. 11.4 × W. 12.4 × Th. 4.6 cm, from Tarkhan, Tomb 414, BSAE excavations 1911–1913 (“Fayum Entrance Area”) | object record only; no discussion of how the sealing was made | Facts only; image not used | Voice revision 2026-09-25 |
| `source.egypt.the-past-tomb-u-j` | [“The discovery of Tomb U-j”, *The Past*](https://the-past.com/shorts/the-picture-desk/the-discovery-of-tomb-u-j/) | Archaeology magazine (Current Publishing) | 1988 discovery by a DAIK team led by Günter Dreyer; “some 150” ivory and bone labels; “Forty-three contain just vertical or horizontal numbers” | popular summary; dates the tomb c. 3100 BCE, later than the Regulski date the lesson keeps, so no date is taken from it | Facts only | Voice revision 2026-09-25 |
| `source.egypt.archaeology-abydos-glyphs` | [“Earliest Egyptian Glyphs”, *Archaeology* 52.2 (March/April 1999)](https://archive.archaeology.org/9903/newsbriefs/egypt.html) | Archaeological Institute of America magazine news report | label size “2 by 1 1/2 centimeters”, “between one and four glyphs”; labels as commodity tags | short news report; its dating (3400–3200 BCE) and readings are not used | Facts only | Voice revision 2026-09-25 |
...
| `claim.egypt.palette-discovery` | James Quibell and Frederick Green found the Narmer Palette during excavations at Nekhen (Hierakonpolis) in 1897–1899. | Observation | High | Hierakonpolis Expedition; Stevenson p. 5 (“Main Deposit”) | Find years as the Expedition gives them | Voice revision |
| `claim.egypt.palette-most-reproduced` | The Hierakonpolis Expedition calls the Narmer Palette probably the most reproduced image from ancient Egypt after Tutankhamun’s golden mask. | Interpretation | Medium | Hierakonpolis Expedition | Attributed to the Expedition in the prose | Voice revision |
| `claim.egypt.main-deposit-not-original` | The buried “Main Deposit” at Hierakonpolis where the Palette was found was not the place where it was made or used. | Interpretation | High | Stevenson p. 5 | Recorded for the note and the open question below; the prose says only that the Palette “lay” at Nekhen | Voice revision |
| `claim.egypt.nekhen-brewery` | Around 3600 BCE, Nekhen had breweries that its excavators estimate could make about 300 gallons of beer a day. | Interpretation | Medium | Hierakonpolis Expedition | Labelled as the excavators’ estimate | Voice revision |
| `claim.egypt.nekhen-animal-burials` | A cemetery at Nekhen holds early animal burials, including baboons, dogs, and cattle, and the only known elephant burial, dated about 3600 BCE. | Observation | High | Hierakonpolis Expedition | No claim about whose cemetery it was or what the burials meant | Voice revision |
| `claim.egypt.everyday-palettes` | Ordinary Predynastic palettes were used to grind minerals, most often green malachite, probably to make eye paint. | Interpretation | Medium | Stevenson pp. 3–4 | Eye paint kept as “probably” (Petrie’s hypothesis, supported by Adaima traces) | Voice revision |
| `claim.egypt.ceremonial-palette-count` | Just over 25 ceremonial palettes are known, whole or in fragments. | Observation | High | Stevenson pp. 4–5 | Restricted ownership stated as Stevenson’s inference (“seem to have belonged”) | Voice revision |
| `claim.egypt.grinding-circle-unused` | Many ceremonial palettes keep a circular area for grinding minerals, but they lack traces of grinding. | Observation | High | Stevenson p. 5 | Stated for ceremonial palettes as a class, not as a separate test of the Narmer Palette | Voice revision |
| `claim.egypt.serpopards` | The long-necked creatures on the Narmer Palette, often called serpopards, are held in check by human figures and are regarded as motifs drawn from Near Eastern art. | Interpretation | Medium | Ministry record; Stevenson p. 5 | “Scholars see…”; links back to the Uruk lesson without claiming direct contact | Voice revision |
| `claim.egypt.smiting-image-endured` | The image of the king about to strike an enemy became a lasting symbol of Egyptian kingship and was still carved on the last ancient Egyptian temples. | Observation | High | Ministry record | No claim that the Palette itself was the model | Voice revision |
| `claim.egypt.literal-readings` | Early twentieth-century scholars treated ceremonial palettes such as the Narmer Palette as records of actual events; such literal readings are seldom fully accepted today. | Interpretation | High | Stevenson p. 5 | Replaces the unsourced “for a long time” wording | Voice revision |
| `claim.egypt.herodotus-menes` | In the 400s BCE, Egyptian priests told the Greek writer Herodotus that the first king, Min, dammed the Nile to make dry land and founded Memphis there. | Later tradition | High | Herodotus 2.99 (Godley); Smith | High certainty that the tradition was told, not that it happened | Voice revision |
| `claim.egypt.manetho-menes` | Manetho, an Egyptian priest writing in Greek in the 200s BCE, named Menes as the first king; surviving excerpts of his work say Menes was carried off by a hippopotamus. | Later tradition | High | Waddell, Introduction and Frs. 6–7(a) | High certainty that the excerpts say it; the reign length is omitted because versions differ | Voice revision |
...
Runbook: `docs/content/lesson-voice-revision-runbook.md`. Branch: `claude/egypt-nile-state-revision-ulzxs8` (the session’s assigned branch, used in place of `revise/egypt-nile-state-voice`). Started 2026-09-25. Status: **approved by the owner 2026-09-25, including the Narmer mace-head addition; merge completes the revision**. PR: [#63](https://github.com/dev-vibe/chronos-learning/pull/63).

### Audit of the published version

| Section | What read flat |
| --- | --- |
| `section.egypt.river-corridor` | Opened on a “Stand beside the Nile” scene-setting device with no person, object or event; lists of general nouns (“fields, settlements, boats, animals, workshops”); the Palette, the lesson’s central object, did not appear. Knowledge eyebrow “Read the river” was a slogan rather than a plain label. |
| `section.egypt.before-one-king` | Opened by announcing a misconception (“It is tempting to imagine…”); abstract lists of processes with no specific place detail, although the Hierakonpolis Expedition gives Nekhen’s breweries and animal burials. Eyebrow “Not one switch” was a slogan. |
| `section.egypt.read-palette` | Object introduced generically (“A green-gray stone object…”); how and where it was found was missing; the “central hollow” was named without saying what it was; methods voice at the end (“These are observations. What they prove comes next.”). |
| `section.egypt.palette-limits` | Menes was named but his story never told; “for a long time, scholars often read…” had no date or source; the section ended on a moral about method (“Evidence gets stronger when we preserve that boundary…”). |
| `section.egypt.administration` | The “Someone unloaded them” run worked, but Narmer vanished from this section, the Abydos labels had no find story, and the section ended on an abstract sentence about Memphis. The knowledge lead was general (“The ruler was visible on stone…”). |
| `section.egypt.world-check` | Prompts only; not changed. |

Whole lesson: story spine `none` (a sequence of topics); memorable moments: the catfish-and-chisel name only; the opening did not land (a scene-setting device instead of a moment); the ending did not land (a strategic sentence about Memphis, then a reconstruction disclaimer).
...
- The open question of where the Palette was used before it was buried (Stevenson: the Main Deposit “is clearly not the context of their original manufacture or use”): recorded as a claim but not added to the prose, to keep section 4 to one job.
- Diodorus’s later story of Menes rescued by a crocodile (cited in Waddell’s notes): not read in its source.
...
- Story spine: the Narmer Palette, from its discovery at Nekhen in 1897–1899, beside the Narmer mace-head from the same deposit, to Narmer’s name on a plain mud jar sealing and the unnamed workers who kept the state running.
- Memorable moments: the Palette dug up at Nekhen, now probably the most reproduced image from ancient Egypt after Tutankhamun’s mask, with a grinding circle that ceremonial palettes show no traces of using; the smiting pose still carved on the last temples ancient Egyptians built; the later legends of the first king damming the Nile for Memphis (Herodotus) and Menes carried off by a hippopotamus (Manetho), with Narmer in neither; Narmer’s name on a mud jar sealing and the thumbnail-sized Abydos labels, forty-three of them carrying only numbers; the 8-kilogram mace-head and its carved count of 400,000 oxen, 1,422,000 goats and 120,000 captives.
- Added claims: `claim.egypt.palette-discovery`, `palette-most-reproduced`, `main-deposit-not-original`, `nekhen-brewery`, `nekhen-animal-burials`, `everyday-palettes`, `ceremonial-palette-count`, `grinding-circle-unused`, `serpopards`, `smiting-image-endured`, `literal-readings`, `herodotus-menes`, `manetho-menes`, `narmer-sealing`, `abydos-labels-find`, `abydos-label-size`, `macehead-find`, `macehead-ceremonial`, `macehead-scene`, `macehead-readings`, `macehead-numbers-claim`. Sources added: `source.egypt.met-narmer-sealing`, `the-past-tomb-u-j`, `archaeology-abydos-glyphs`, `herodotus-godley`, `smith-herodotus`, `waddell-manetho`, `mcnamara-narmer-macehead`, `ashmolean-origins-gallery`, `wilson-horned-beasts`, `commons-narmer-macehead-quibell`.
- Added images: `media.egypt.narmer-macehead` (J. E. Quibell, *Hierakonpolis I*, 1900; public domain), in `module.egypt.macehead-evidence` in section 4. Storage publication (`media:publish`, `media:verify:remote`) needs the trusted storage credentials and was handed to the owner; the committed rollback copy serves until then.
