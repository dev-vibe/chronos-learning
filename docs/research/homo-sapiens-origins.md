...
| `source.humans.wong-2017-sciam` | Wong, K. "Ancient Fossils from Morocco Mess Up Modern Human Origins." [*Scientific American*](https://www.scientificamerican.com/article/ancient-fossils-from-morocco-mess-up-modern-human-origins/), 8 June 2017 (print, vol. 317 no. 3) | Science journalism reporting the 2017 papers with the excavators | irhoud-first-reading | Secondary account of research history; used only for the find story, not for anatomy or dates of the new fossils | Consistent with Hublin 2017 and Richter 2017 on the new fossils and date | Rights-reserved; paraphrase only, no quotation or images | Voice revision, 2026-09-24, close-reviewed: paragraphs on the 1961 barite mining, the first reading as c. 40,000-year-old African Neanderthals, the redating to c. 160,000 years, and the new fossils from a part of the site the miners had not disturbed |
| `source.humans.smithsonian-omo-i` | "Omo I." [Smithsonian Institution Human Origins Program](https://humanorigins.si.edu/evidence/human-fossils/fossils/omo-i) | National museum fossil record | omo-age-history | Public summary; still lists the superseded c. 195,000-year age, which the lesson gives only as a past estimate | Vidal 2022 cites the c. 197 ka estimate it replaces | Public educational content; text cited, images not redistributed | Voice revision, 2026-09-24, close-reviewed: discovery (1967, team led by Richard Leakey), “originally thought to be about 130,000 years old”, sediments re-dated in 2008, “about 195,000 years old” |
| `source.humans.si-olorgesailie-2018` | "Scientists Discover Evidence of Early Human Innovation, Pushing Back Evolutionary Timeline." [Smithsonian Institution newsdesk](https://www.si.edu/newsdesk/releases/scientists-discover-evidence-early-human-innovation-pushing-back-evolutionary-timeline), 15 March 2018 | Excavating institution's release on Brooks 2018 and companion papers | olorgesailie-change | Press release; used only for details the papers also report | Brooks 2018 (registered) | Public release; paraphrase only | Voice revision, 2026-09-24, close-reviewed: handaxes made “for hundreds of thousands of years”; smaller, more carefully shaped tools at 320,000–305,000 years ago; obsidian sources “in multiple directions”; black and red rocks, manganese and ocher, processed as colouring material |
...
| `claim.humans.kabwe-site-lost` — The Kabwe (Broken Hill) cranium was recovered from cave deposits during metal-ore mining in 1921, and the original site has since been completely quarried away. | observation | high | grun-2020 | — | — | Voice revision: used in section 2 and in the closing “Where nobody has looked” item; wording updated to the source's exact claims | editorial-review-required; voice revision close-reviewed 2026-09-24 against the Grün 2020 abstract |
...
| `claim.humans.irhoud-first-reading` — Miners digging for barite at Jebel Irhoud found a human skull in 1961; the fossils were first thought to be African Neanderthals about 40,000 years old, were later redated to roughly 160,000 years, and new fossils were later excavated from a part of the site the miners had not disturbed. | observation | high | wong-2017-sciam | History of interpretation, not a claim about the fossils themselves | Moroccan miners and the first Moroccan and French researchers are unnamed in the source | Voice revision: opening story and closing callback | editorial-review-required; voice revision close-reviewed 2026-09-24 |
| `claim.humans.omo-age-history` — The Omo I fossil was found in 1967 by a team led by Richard Leakey; it was first thought to be about 130,000 years old, and redating of its sediments in 2008 gave about 195,000 years. | observation | high | smithsonian-omo-i, vidal-2022 | Both earlier ages are superseded; given only as past estimates | Kenyan and Ethiopian team members unnamed | Voice revision: shows dates moving as evidence improves | editorial-review-required; voice revision close-reviewed 2026-09-24 |
| `claim.humans.omo-ash-match` — The ash layer above Omo I is a more-than-2-m-thick deposit of fine ash too fine-grained to date directly; the chemistry of its glass matches the products of a major explosive eruption of Shala volcano, about 350 km to the northeast, whose deposits near the volcano were dated instead. | observation | high | vidal-2022 | The correlation is geochemical; the date is of the eruption, so it is a minimum for the fossil | — | Voice revision: the detective story behind `omo-minimum-age` | editorial-review-required; voice revision close-reviewed 2026-09-24 |
| `claim.humans.olorgesailie-change` — People at Olorgesailie made large handaxes for hundreds of thousands of years before smaller, more carefully shaped tools appear there about 320,000–305,000 years ago; the obsidian came from sources in several directions, and black and red rocks (manganese and ochre) were processed as colouring material. | observation | high | si-olorgesailie-2018, brooks-2018 | Sources report the before and after, not how or how fast the change happened, so the lesson says the handaxes “are gone” in the later layers rather than describing a gradual switch | — | Voice revision: before-and-after contrast in section 5 | editorial-review-required; voice revision close-reviewed 2026-09-24 |
...
| --- | --- |
| `section.humans.skull-in-the-wrong-place` | Strong idea, flat telling: a run of short same-length sentences (“Nobody knew what to make of it. It did not look like anyone expected.”) where a specific story exists; the misreading of the fossils as 40,000-year-old Neanderthals was reduced to “people thought the site was much younger”. |
| `section.humans.what-counts-as-us` | Item label “A fossil is not a photograph” uses the camera/photograph metaphor the runbook rules out; the Kabwe item was general (“a person from Kabwe”) although the ledger held the story of the quarried cave. |
| `section.humans.read-the-skull` | Good close-reading; minor choppiness; ending announced the next question (“So the next question is…”). |
| `section.humans.across-a-continent` | The Omo I dating, the best detective story in the lesson, was told as a method note; the no-birthplace limit was explained twice here and again in section 6; “are younger than both” overstated a minimum age. |
| `section.humans.connected-not-sealed-off` | Olorgesailie read as a list; the before-and-after contrast (handaxes for hundreds of thousands of years, then something new) was missing. |
| `section.humans.what-dna-adds` | Opened on a hedge rather than the 2023 study; “Read that carefully” lectured; the limits box ended on a method caveat instead of an ending. |
| `section.humans.check-and-complete` | Prompt explanations accurate; a few short-sentence runs. |

Whole lesson: story spine `partial` (Jebel Irhoud opens sections 1, 3 and 5 but the lesson never returns to it at the end); memorable moments `one` (a skull in the wrong place); opening landed as an idea but read flat; ending did not land (a list of limits).

### Story material

- **Story spine:** the Jebel Irhoud fossils, a skull in the wrong place. Found by barite miners, misread as recent Neanderthals, redated by burned flint, read closely for its mosaic face and braincase, set among other finds across Africa, linked to toolkits elsewhere, and recalled at the end: the most important find in the lesson turned up by accident, so the next one could come from anywhere nobody has looked.
- **Memorable moments:** (1) miners digging for barite in 1961 uncovered a skull later filed as a 40,000-year-old Neanderthal; burned flint from the part they left undisturbed gave about 315,000 years; (2) a face that would not stand out today on a long, low braincase like earlier humans; (3) Omo I’s age moved from 130,000 to 195,000 years, then a volcanic ash too fine to date was matched by its chemistry to an eruption of Shala volcano 350 km away, making the fossil at least 233,000 years old; (4) after hundreds of thousands of years of handaxes at Olorgesailie, people began carrying obsidian from 25–95 km away in several directions and processing black and red rock into colour; (5) Kabwe, another skull found by miners, whose cave no longer exists.
- **Sources of the material:** the note's Enrichment item `claim.humans.kabwe-site-lost` (now used); close re-reading of Vidal 2022 and Grün 2020, already registered; targeted research for the Jebel Irhoud find story (Wong 2017), the Omo I date history (Smithsonian Omo I record) and the Olorgesailie before-and-after (Smithsonian 2018 release).
- **Legend used:** none. This lesson has no later tradition; its “stories people told” are the earlier scientific readings, which the lesson labels as superseded.

### Changes

- Prose, knowledge body and item text, evidence body text and prompt explanations rewritten. All IDs, section order, headings, prompts, options, answer logic, media and completion are unchanged. No module removed. Knowledge items in `module.humans.open-questions` were reordered so “Where nobody has looked” closes the lesson with the callback.
- One knowledge item label changed to plain words: “A fossil is not a photograph” → “Fossils are rare survivors”; “Pigment, deliberately made” → “Colour, deliberately made”, because the item now covers black manganese as well as red ochre.
- The no-birthplace limit is now stated once, in section 6; section 4 keeps only the conclusion. “Are younger than both” was corrected to reflect that Omo I has a minimum age.
- 3 sources and 5 claims added to the lesson module; 4 claims are new and `claim.humans.kabwe-site-lost` was already in the ledger (claim and source ledgers above): `claim.humans.irhoud-first-reading`, `omo-age-history`, `omo-ash-match`, `olorgesailie-change`, `kabwe-site-lost`; `source.humans.wong-2017-sciam`, `smithsonian-omo-i`, `si-olorgesailie-2018`.
- Reading length: 1,374 → 1,557 words in the learner-facing modules (+13%). The added length is the Omo I and Olorgesailie stories; hedges and the repeated limit were cut.

### Left out

- Jean-Jacques Hublin’s widely repeated remark that the Irhoud face could belong to someone you might meet today: no primary transcript or reliable quoting source could be opened, so the lesson describes the face without quoting anyone.
- The year the new Jebel Irhoud excavation began (2004 in secondary accounts) and the number of new individuals: not in the sources opened in this pass.
- Florisbad’s find story (1932, at a mineral spring): the registered Grün 1996 article is paywalled and no open source was close-reviewed.
- Kamoya Kimeu, the Kenyan fossil hunter after whom Omo I’s site is named: the name appears in Vidal 2022, but no opened source explained it.
- The earlier c. 500,000-year estimate for Kabwe: seen only in a summary of Grün 2020, not close-read.
- Olorgesailie’s erosional gap between handaxe and Middle Stone Age layers: the open Potts 2020 text could not be retrieved in this pass.

### Stage 14B check on the changed sections

| Question | Finding | Evidence and disposition |
| --- | --- | --- |
| Story | pass | Spine and moments above. Opens on miners and a misread skull; section 4 tells the Omo I date as a detective story; section 5 has a before-and-after; the last item calls back to the miners. The section 2 and section 6 knowledge boxes stay as four parallel items, which is their clearest form. |
| Evidence reasoning | pass | Earlier readings (40,000-year Neanderthal, 130,000 and 195,000 for Omo I) are labeled as superseded; the Omo I age stays a minimum, now explained step by step; the Olorgesailie trade-or-ranging alternative is kept; the DNA result stays “what a model fits”. Both prompts remain answerable from the lesson. |
| Proportionality | pass | The African origin is stated without false balance; the species-boundary dispute and climate cause keep their limits; no exoticism; human remains handled as evidence. The one overstatement found (“younger than both”) is corrected. |
| Cognitive load | pass | New names: barite (context makes it “something mined”), Kabwe/Broken Hill, Omo I, Richard Leakey, Shala, manganese, ochre, Nama. Each is used once in context; no new technical vocabulary. Section 4 is the densest paragraph and keeps one actor per sentence. |
| Headings | pass | Headings unchanged and plain; one metaphor item label replaced. |

`npm run validate:content` passed; `npm run test:domain` passed (14 files, 63 tests). No test pinned the changed text. `tests/learn/multi-lesson.test.tsx` fails identically on `main` (journey-summary list predates the Indus, Kerma and Akkad entries); unrelated to this revision.
