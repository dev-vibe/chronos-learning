...
| `source.humans.clarkson-2017-conversation` | Clarkson, Marwick, Wallis, Fullagar and Jacobs, “Buried tools and pigments tell a new history of humans in Australia for 65,000 years” (The Conversation, July 2017): https://theconversation.com/buried-tools-and-pigments-tell-a-new-history-of-humans-in-australia-for-65-000-years-81021 | Excavation team’s own public account | Voice revision, 2026-09-24, close-reviewed: “In 2012 and 2015 our team excavated an area of 20 square metres at Madjedbebe”; “A small excavation in 1989 at this site had proposed evidence for human activity in Australia at 60,000-50,000 years ago”; critics “pointed to the sandy deposit … artefacts may have been easily moved down into older layers by trampling or burrowing animals”; the agreement with the Gundjeihmi Aboriginal Corporation “gave ultimate control over the excavation to the Mirarr senior custodians”; lowest levels held “many pieces used for seed grinding and ochre ‘crayons’” and “the world’s oldest known edge-ground hatchets”; “We measured thousands of sand grains individually … We also had another lab analyse some samples” | Written by the long-chronology team; its account of critics is theirs | Nature 2017 abstract; Hayes 2022 | Paraphrase only; no quotation in runtime | reviewed |
| `source.humans.florin-2020-plant-foods` | Florin et al., “The first Australian plant foods at Madjedbebe, 65,000–53,000 years ago” (Nature Communications 11, 924, 2020): https://doi.org/10.1038/s41467-020-14723-0 | Peer-reviewed archaeobotany | Voice revision, 2026-09-24, close-reviewed: Abstract (charred plant food remains dated 65–53 kya; a range of plant foods “including those requiring processing”); Results, endocarp: extracting kernels from the “fibrous and mechanically-resistant” *Pandanus spiralis* drupe “is a labour-intensive process when using stone tools”; Results, vegetative parenchyma: fragments “comparable to charred peelings” of cooked tubers; Discussion: “the cooking (and peeling) of USOs and palm stems … and the laborious extraction of *Pandanus spiralis* kernels” | Its dates inherit the Madjedbebe chronology debate; the lesson says “earliest layers”, not a number | Hayes 2022 plant-processing residues | CC BY 4.0; cited as fact source only | reviewed |
| `source.humans.nunn-reid-2015-conversation` | Nunn and Reid, “Ancient Aboriginal stories preserve history of a rise in sea level” (The Conversation, 2015): https://theconversation.com/ancient-aboriginal-stories-preserve-history-of-a-rise-in-sea-level-36010 | Authors’ public account of their later-tradition research | Voice revision, 2026-09-24, close-reviewed: “we analysed 18 stories from around Australia’s coast”; Narrangga people of Yorke Peninsula “recall the time when there was no Spencer Gulf, only ‘marshy country reaching into the interior’ … dotted with ‘freshwater lagoons’ … One day the sea came in”; “they may have originated 12,000 years ago … they are likely to be more than 9,000 years old” | Outsider researchers’ summary and dating of community stories; stories paraphrased, not reproduced | Nunn & Reid 2016 (peer-reviewed) | Paraphrase only | reviewed |
...
| `claim.humans.sahul.madjedbebe-dig` — In 2012 and 2015 a team excavated the deep sandy floor of Madjedbebe, a rock shelter on Mirarr Country, under an agreement that gave Mirarr senior custodians ultimate control over the excavation. | observation | high | Clarkson et al. 2017 (Conversation); Hayes et al. 2022 (site description: “at the foot of an outlying massif adjacent to the western Arnhem Land plateau … within Mirarr Country”; excavated “to a maximum depth of 4 m”) | “Deep” rests on the 4 m maximum; the lesson gives no depth number. | The agreement is described by the research team; Mirarr voices are not quoted. | Voice revision: opening moment (section 1) | reviewed |
| `claim.humans.sahul.lowest-layer-finds` — The lowest artefact layers at Madjedbebe include grinding stones, ochre “crayons” used to make pigment, and hatchet heads with ground edges. | observation | high | Clarkson et al. 2017 Nature abstract (“grinding stones, ground ochres, reflective additives and ground-edge hatchet heads”); Clarkson et al. 2017 (Conversation) | Their age is the contested 65 ka; the lesson says so in the same paragraph. | — | Section 1 opening | reviewed |
| `claim.humans.sahul.routes-and-longest-crossing` — Routes to Sahul ran north through Sulawesi toward New Guinea or south through Timor toward northwestern Australia; each needed several sea crossings, at least one approaching 100 km, in voyages lasting days. | interpretation | high | Bird et al. 2019, Abstract (“multiple maritime crossings through Wallacea, with at least one approaching 100 km”; “open-sea voyages lasting several days”) and Introduction (northern route through Sulawesi into New Guinea; southern route through Bali and Timor) | Distances change with the sea-level curve used. | Travellers’ own routes unknown. | Section 2 | reviewed |
| `claim.humans.sahul.founding-population` — One modelling estimate holds that at least about 1,300 founders were needed for Sahul’s population to avoid dying out, arriving in several coordinated voyages over a few centuries. | interpretation | moderate | Bird et al. 2019, Discussion (“a founder population of at least ~1300 individuals is required to avoid extinction in Sahul”; “multiple, coordinated voyages by hundreds of individuals over a relatively short time frame of several centuries”) | Demographic model; the lesson attributes it to “one study” and says it depends on assumptions. | — | Section 2, once | reviewed |
| `claim.humans.sahul.drift-odds` — In voyage models, random drift gave less than a 5% chance of reaching Sahul unless at least 40 adults were washed off an island every 20 years; choosing when to leave and making minimal headway (0.5 knots) toward land greatly raised the chance of arrival. | interpretation | moderate | Bird et al. 2019, Abstract | Model assumptions (windage, craft, survival). 0.5 knots ≈ 0.93 km/h, given to learners as “less than 1 kilometre an hour”. | — | Section 3 and its knowledge item | reviewed |
| `claim.humans.sahul.earlier-dig-dispute` — A small 1989 excavation at the site proposed human activity 60,000–50,000 years ago; critics argued that trampling or burrowing animals could have moved artefacts down into older layers of the sandy deposit. | observation | high | Clarkson et al. 2017 (Conversation) | The team’s summary of its critics; the live dispute is carried by `madjedbebe-window`. | — | Section 4 opening | reviewed |
| `claim.humans.sahul.single-grain-dating` — The later Madjedbebe team measured thousands of sand grains individually and had a second laboratory analyse some samples. | observation | high | Clarkson et al. 2017 (Conversation) | Method rigour does not settle association; the lesson says so next. | — | Section 4 (learner text keeps “one by one”; the second-lab check was cut for length) | reviewed |
| `claim.humans.sahul.artefact-refits` — The excavation team argues that the Madjedbebe layers stayed in order, citing broken stone artefacts that fit back together. | interpretation | moderate | Clarkson et al. 2017 Nature abstract (“stratigraphic integrity of the deposit demonstrated by artefact refits”) | Critics (Allen & O’Connell 2014 line; Veth et al. 2025 on the state of the debate) keep the association contested. | — | Section 4, attributed to the team, followed by the counterargument | reviewed |
| `claim.humans.sahul.grinding-stone-uses` — Microscopic and chemical study shows the Madjedbebe grinding stones were used most often to process plants and next most often to process ochre pigment. | observation | high | Hayes et al. 2022, Results (“Plant processing was the most common task … 60 grinding stones”; “Pigment processing was the second most common task … 17 grinding stones”) | Applies to the analysed assemblage, not to each pictured stone; the caption says “stones like these”. | — | Evidence caption | reviewed |
| `claim.humans.sahul.early-plant-foods` — Charred remains from Madjedbebe’s earliest layers show people peeled and cooked roots and tubers and extracted pandanus kernels from their hard, fibrous drupes, a labour-intensive task with stone tools. | observation | high | Florin et al. 2020, Results and Discussion | Dates inherit the contested chronology; the lesson gives no number here. | — | Section 5 ending | reviewed |
| `claim.humans.sahul.spencer-gulf-story` — Narrangga stories from Yorke Peninsula recall a time when Spencer Gulf was marshy country with freshwater lagoons until the sea came in; researchers argue the stories may be more than 9,000 years old. | later-tradition | moderate | Nunn & Reid 2015 (Conversation); Nunn & Reid 2016 | Researchers’ dating of a story; not a record of the first crossing, and the lesson says so. | Community’s own telling not quoted. | Section 5, replacing the general sentence | reviewed |
...
| --- | --- |
| `section.humans.sahul.landmass` | Opened on a map fact (“On a map today…”), then a recap, then an announced question (“How did people make those journeys…?”). No person, place or object; Madjedbebe, the lesson’s one real site, did not appear until section 4. |
| `section.humans.sahul.open-water` | General where specifics exist: “tens of kilometres” when the source says one crossing approached 100 km; the settlement point (“enough people had to reach Sahul”) had no number although Bird 2019 gives one; three short same-weight paragraphs. |
| `section.humans.sahul.planned-crossing` | Methods voice (“They include… They compare…”); the model’s striking results (below 5% by drift; slow headway changes everything) were summarized as “much more likely”; the limit sentence repeated a hedge already made. |
| `section.humans.sahul.dated-sand` | Opened on an announced question; the find had no story although the site has a 1989 dig and a public fight over it; the team’s own evidence for intact layers (refits) was missing, so the disagreement read as assertion against assertion. |
| `section.humans.sahul.what-we-can-know` | General later-tradition sentence where a specific, sourced story exists; the ending was a summary with a moral (“the achievement is clear… capable of planning and working together”) rather than a callback. |

Whole lesson: story spine `none`; memorable moments `one` (the sand is dated, not the tools); opening did not land (map fact plus announced question); ending did not land (summary).

### Story material

- **Story spine:** the Madjedbebe rock shelter on Mirarr Country. It opens the lesson as a dig in 2012 and 2015 with the finds from its lowest layers; its unknown makers’ ancestors pose the crossing question for sections 1–3; section 4 returns to it for the 1989 dispute and the grain-by-grain dating; the ending returns to the charred meals in its earliest layers and the sand still being argued over.
- **Memorable moments:** (1) grinding stones, ochre “crayons” and ground-edge hatchets at the bottom of a shelter dug under Mirarr control; (2) at least one crossing close to 100 km, and one study’s estimate of at least about 1,300 founders; (3) drifting at random, under 5% odds, but heading for land at less than 1 km an hour changes the outcome; (4) the 1989 dig, its critics’ trampling-and-burrowing objection, and the new team’s grain-by-grain dating and refits; (5) Narrangga stories of Spencer Gulf as marshy country with freshwater lagoons before the sea came in (labelled later tradition); (6) charred pandanus shells and tuber peelings in the earliest layers.
- **Sources of the material:** close re-reading of registered sources (Bird et al. 2019 abstract, introduction and discussion; Clarkson et al. 2017 abstract; Hayes et al. 2022 results and site description); targeted research for the dig story (Clarkson et al. 2017 in The Conversation), the plant foods (Florin et al. 2020) and one specific sea-level story (Nunn & Reid 2015 in The Conversation).
- **Later tradition used:** the Narrangga Spencer Gulf story, labelled in the text as a tradition “long after the first crossings, not accounts of the arrival” and recorded as `later-tradition` / moderate.
- **Cumulative link:** section 1 picks up the migrations lesson’s closing line (“Some groups kept moving east…”).
...
- Inter-island visibility (Bird 2019: on the southern route the Sahul Banks were visible from high points near the Timor and Roti coasts but not from the coast). Vivid, but it applies only to the less likely route and would add load.
- The “world’s oldest” labels for the edge-ground hatchets and reflective pigment: claimed by the excavators, but they depend on the contested 65 ka date and would read as settled.
- A quotation from a Mirarr custodian: none found in a source that could be close-read in this pass.
- The Madjedbebe former name (Malakunanja II), the 1973 first excavation, and the reflective mica additive: accurate but not needed for the story.
- Why seas were lower (water held in ice sheets): true but unregistered; the lesson names melting ice only where the registered later-tradition claim already does.

### Stage 14B check on the changed sections

| Question | Finding | Evidence and disposition |
| --- | --- | --- |
| Story | pass | Opens on the dig; the shelter returns in section 4 and at the end; sections 2–3 carry the crossing with concrete numbers. Knowledge boxes keep their parallel items. |
| Evidence reasoning | pass | The 65 ka date is flagged as argued over in the first paragraph; section 4 attributes the refits to the excavation team and gives the critics’ case after it; the 1,300 figure is “one study” and model-dependent; the Spencer Gulf story is labelled later tradition. Prompt 1 is answerable from section 4 and the caption; prompt 2 from sections 2–3 (drift odds, founders, no surviving craft). |
| Proportionality | pass | 50 ka stays the safer claim and 65 ka contested; no boat is described; the planning conclusion is attributed to the model with its limit stated once; Mirarr control of the dig and Narrangga stories give Aboriginal people present-day agency without speaking for them. |
| Cognitive load | pass | New names: Madjedbebe (earlier in section 1 instead of section 4), Mirarr, Sulawesi, Timor, Narrangga, Yorke Peninsula, Spencer Gulf, pandanus. Numbers: 100 km, 1,300, 5%, 40 adults / 20 years, 1 km an hour, 1989 — each appears once. Section 3 is the densest paragraph; one result per sentence. |
