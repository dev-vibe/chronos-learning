...
| `claim.caral.dating-published-2001`: Ruth Shady Solís, Jonathan Haas, and Winifred Creamer published Caral’s radiocarbon dates in Science in 2001. | observation | high | Science 2001 (byline; *Science* 292 no. 5517, 27 April 2001, pp. 723–726; PubMed record 11326098 read 2026-09-25) | Names the publishing authors, not the whole excavation team | Excavation workers and specialists outside the byline are unnamed | One sentence in the opening; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.eighteen-supe-sites`: Caral is one of 18 large preceramic sites in the Supe Valley. | observation | high | Science 2001 (abstract, final sentence: “Caral is one of 18 large preceramic sites in the Supe Valley”; read 2026-09-25 from the PubMed record 11326098) | Site counts differ by survey and later work; the count is the Supe Valley only | Smaller settlements are under-described | One number in section 2, beside the existing regional-sites claim; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.first-pyramid-same-era`: Caral’s monumental building had begun by about 2627 BCE, roughly when Egypt’s first pyramid was built for King Djoser at Saqqara, around 2630 BCE on the chronology the nomination file cites; the two developed independently. | interpretation | moderate | Science 2001 (abstract); UNESCO nomination, comparative table, PDF p. 32 (printed p. 24): “In about 2630 king Djoser built the first pyramid in Egypt here in Saqqara” | Egyptian Old Kingdom dates are revised by decades in recent models (see the pyramids lesson); “roughly” and “about” carry that | Neither society’s builders are named | One sentence in the opening; timing only, not contact; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.fisher-farmer-exchange`: According to the excavators, coastal fishers supplied dried anchovies and shellfish while valley farmers supplied cotton, gourds, squash, beans, sweet potatoes, and other plants; Áspero faced one of the richest anchovy fisheries, and a cotton fishing net at least 8 by 4 meters was found at the early fishing village of Bandurria. | interpretation | moderate | Shady 2006, pp. 62–63 (“anchoveta seca… a cambio… algodón, mate, zapallo… fréjol, camote”; “uno de los bancos de anchoveta más ricos”; nets “de, por lo menos, 8 por 4 metros” found by Fung 1988 at Bandurria); UNESCO nomination, PDF pp. 27–28 (printed pp. 19–20): cotton “to make textiles and, importantly, fishing nets”; “mass extraction of fish, in particular the Peruvian anchovy” | The excavators’ exchange model; who controlled the trade is debated (see `cotton-fish-exchange`) | Individual fishers and traders are unnamed | Section 2; the net size is attached to fishing nets generally, the note names Bandurria; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.greater-pyramid-plaza`: The Greater Pyramid is Caral’s largest building, about 150 by 170 meters at the base and 19 to 30 meters high; its sunken circular plaza has an inner diameter of about 21.5 meters, inner walls estimated at about 3 meters high, and a stairway leading toward the mound. | observation | high | UNESCO nomination, “The Greater Pyramid”, PDF p. 10 (printed p. 2): “149,69m from north to south, 170,80m from west to east… height of 19,27m to the south and 29,88m to the north”; “internal walls were 3 m. high”; “internal diameter of the sunken part is 21,5 m” | Wall height is an estimate; measurements are of the conserved monument | Users of the plaza are unrecorded | Section 3, beside the plaza photograph (which shows this plaza); added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.unequal-tables`: The excavators report that large fish, anchovies, shellfish, and deer meat frequently reached the tables of Caral’s authorities and officials. | interpretation | moderate | Shady 2006, p. 80 (“Pescados grandes, anchovetas, moluscos y carne de venado llegaron con frecuencia a la mesa de las autoridades y funcionarios”) | Excavator’s synthesis; the lower-status diet in the same passage rests on one skeleton and is not used | Low-status households are faint | One clause in section 3; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.human-hauling`: No pack animals were used; stone was moved from quarries with ropes and plant-fiber bags made for the purpose, and shicra were woven reed bags. | interpretation | high | Shady 2006, p. 77 (“traslado con sogas y bolsas de fibra vegetal, manufacturadas para estos fines”), p. 80 (“En esa época no se utilizaban animales de carga”); UNESCO nomination, PDF p. 11 (printed p. 3): “shicras (woven reed bags)” | Other plant fibers were also used; “reeds” follows the nomination’s gloss | Haulers are unnamed | Section 4; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.burial-and-rebuilding`: Caral’s public buildings were rebuilt in repeated cycles: older rooms were buried, often with shicra bags full of stones, and new rooms were built on top. | observation | high | UNESCO nomination, PDF pp. 10–12 (printed pp. 2–4): “The construction of the late rooms implied the burial of the earlier ones”; “massive use of shicras (woven reed bags) for burying old rooms”; the Gallery “was buried with shicra bags full of stones”; Shady 2006, p. 78 (“varios ciclos de enterramiento y de reinicio”) | Shady’s reading of the cycles as ritual timed to astral movements is not used | Builders unnamed | Section 4 (“each mound holds older versions of itself inside”); added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.bone-flutes`: A set of 32 small bone flutes, decorated with incisions and red and black paint, was found in the sunken circular plaza of the Amphitheater Temple, the largest sunken circular plaza in Caral. | observation | high | UNESCO nomination, “The Amphitheater Temple”, PDF pp. 15–16 (printed pp. 7–8): “connected with the largest sunken circular plaza in the city”; “A set of 32 small bone flutes was found in the upper southwestern side of this sunken plaza. They were decorated with incisions and red and black paint.” Spanish text repeats it (“32 flautas traversas”) | The nomination does not name the animal; popular accounts of condor and pelican bone are not used. The published lesson’s “bird-bone” is corrected to “bone” | Players and music are unrecorded | Section 4; replaces the unsourced flute sentence. The lesson says “the city’s largest sunken plaza” rather than “Amphitheater”, keeping the prototype review’s decision not to use that label; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
| `claim.caral.quipu-twelfth-step`: The knotted fiber object was part of an offering placed on the twelfth step of the central stairway of the Gallery Pyramid, with objects the excavators link to the sea and to music. | observation | high | UNESCO nomination, “The Gallery Pyramid”, PDF p. 12 (printed p. 4): “an offering package placed on the twelfth step of the central stairway of the pyramid, which included a quipu associated with a series of cultural elements linked with activities associated with the sea and music” | The find context is observed; the quipu identification stays contested under `quipu-contested` | If it is a record, it is still unread | Section 5; added in the 2026-09-25 voice revision | Reviewed 2026-09-25 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `section.caral.another-way` | Another way to build a city | Break the Uruk/Egypt checklist and pose the problem | no-checklist; late-archaic-range | prose | hero photograph | The missing pottery becomes the puzzle |
...
| 4 | `section.caral.how-built` | How the monuments were built | Turn monumentality into dated human work | shicra; caral-dates; preceramic | prose; reconstruction; knowledge | reconstruction | Work done, now bound the claims |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `intention.caral.site-hero` | masthead | What does the plaza and Pirámide Mayor look like as surviving architecture? | style-only illustration of conserved ruins | Product-owner aerial of the plaza–pyramid axis; UNESCO architectural identification; independent Commons front-view check | Illustrated from surviving ruins · not a photograph, not a reconstructed city | Alt text naming plaza, stairway, terraces, and valley | Style-only hero from the requested aerial | approved |
...
| --- | --- |
| ![Product-owner aerial used as the locked composition](references/caral/piramide-mayor-aerial-hero-reference.png) | Product-owner supplied aerial of Pirámide Mayor and its sunken circular plaza, used only as a non-redistributed composition reference for a Chronos-original style-only illustration.<br>Accessed: 2026-08-20. |

- Repository research copy and SHA-256: `docs/research/references/caral/piramide-mayor-aerial-hero-reference.png`; `5eaa62d09616b2d660ba698f1fb3ffd61fbb83026923b833383db4c0a7f47813`.
- Edit mode: style-only transformation.
- Visual relationship to preserve: high-angle view with circular plaza in the lower center, opposing axial stairways, central staircase, terraced Pirámide Mayor with room-like stone enclosures, dry terrace, and green irrigated valley behind.
- Locked layout/detail invariants: camera angle; plaza position/proportion; stair axis; terrace rooms; valley crop lines at upper left; trees at upper right; distant ridgeline; warm late-day light; no labels.
- Details not to copy or infer: photographic grain as evidence; people; vehicles; tents; tarps; a reconstructed plastered city.

#### 3. Generation or transformation

- Operation: strict style-only raster edit of the locked aerial, then JPEG compression for runtime delivery.
- Actual input path and SHA-256: `docs/research/references/caral/piramide-mayor-aerial-hero-reference.png`; `5eaa62d09616b2d660ba698f1fb3ffd61fbb83026923b833383db4c0a7f47813`.
- Tool/model/date: Cursor GenerateImage; model version not exposed; 2026-08-20.
- Complete prompt:

```text
Use case: scientific-educational
Asset type: Chronos lesson hero, strict style-only edit
Input image: Image 1 is the edit target and the locked composition. It is a high-angle aerial of conserved Caral ruins: sunken circular plaza in the lower center, axial stairways, terraced Pirámide Mayor with room-like stone enclosures, dry sandy terrace, and a green irrigated Supe Valley behind.

Primary request: Apply only a calm editorial painted-illustration style to Image 1. This is a faithful restyling, not a redesign. Keep it as weathered conserved stone ruins, not a reconstructed living city.

ABSOLUTE COMPOSITION LOCK:
- Preserve the exact 4:3 canvas and camera angle of Image 1.
- Preserve every architectural mass, position, proportion, and spatial relationship.
- Keep the circular sunken plaza in the lower center with a flat sandy floor, thick stone rim, and two opposing stairways on the same central axis.
- Keep the wide central staircase climbing from the plaza onto the stepped terraces of Pirámide Mayor.
- Keep the terraced rooms and rectangular stone enclosures on the mound, including the grid-like walls on the upper platforms.
- Keep the dry orange-tan sandy terrace, faint tracks, and the green valley behind, including the parallel irrigation or crop lines at upper left, sparse trees at upper right, and the distant hazy ridgeline.
- Keep the warm late-day light and the same shadow directions that model the terraces and plaza depth.
- Do not crop, zoom, recompose, simplify, add, remove, replace, mirror, or reinterpret anything.

STYLE CHANGE ONLY:
- Convert the photograph into a museum-quality gouache / editorial landscape illustration with visible but restrained brushwork.
- Use Chronos warm ochres, limestone tans, dusty browns, muted valley greens, and a soft hazy sky.
- Stone walls stay individually readable, not melted into one smooth pyramid.
- No people, vehicles, tents, tarps, flags, titles, captions, labels, watermarks, borders, or UI chrome.
- Do not plaster, paint, or complete the buildings into a reconstructed city of 2600 BCE.

Acceptance criterion: an overlay comparison must show the same layout and all original architectural details; only rendering style may differ.
```

- Candidate/rejection record: a ground-level Commons front view was rejected as the hero after the product owner said it was the wrong photograph. Direct redistribution of the aerial photograph was not used. An earlier Nogueira panorama crop was also replaced.

#### 4. Accepted final image

| Reference used | Accepted final |
| --- | --- |
| ![Reference comparison for the site hero](references/caral/piramide-mayor-aerial-hero-reference.png) | ![Accepted site-hero illustration](generated/caral/caral-site-hero-master.png) |
...
- Comparison verdict — intentional changes: painted illustration style; no people, tents, tarps, or captions.
- Comparison verdict — unsupported details checked: no reconstructed plastered city, no ceremony, no baked-in titles.
...
- Candidate/rejection record: a wider 2014 panorama (`caral-panorama-nogueira-reference.jpg`, SHA-256 `4fb9817c1392a8ffdd0fd2205cf093dc1b76ea430de32f93fcf83cb4580cea34`) was inspected and rejected for this mound-scale job because it repeats the plaza encounter. It is no longer the masthead hero.
...
| `section.caral.coast-and-valley` | Clear but told as a list of short declaratives (“The Pacific Ocean is west. The Andes rise east.”; “Cotton could become nets. Gourds could become floats…”). No specific goods, sizes or numbers. The knowledge body was a methods instruction (“Hold these three relationships in view”). |
| `section.caral.plaza` | Opened with an instruction (“Look for a circular hollow…”); the plaza and mound had no size. Ended on a slogan-shaped line (“not a roll call of named rulers”). The observation box led with methods jargon (“An observation names what survives. An interpretation explains why it may matter.”). |
| `section.caral.how-built` | Opened on a negative (“not poured like modern concrete”). The shicra bags were told as a fact rather than as the thing that dated the city, and nothing said how the mounds grew over time. The flute sentence had no claim behind it and said “bird-bone”, which the nomination file does not. Ended on a summary line (“They solved different problems with different tools.”). |
| `section.caral.what-it-can-prove` | Five paragraphs, each restating a limit, with doubled hedging (“That is important. It is not the same as proving… Absence of those remains is a limit of the evidence, not a complete social portrait.”). The knotted cord had no place or setting. The ending named missing people in the abstract. |
| `section.caral.world-check` | Prompts only; not changed. |

Whole lesson: story spine `none`; memorable moments `one` (flutes: the instruments survive, the songs do not); opening did not land (a mental picture and a time-travel line, then an announced question); ending did not land (a list of limits, then the summary box).

### Story material

- **Story spine:** fiber. The lesson opens on the reed bags of stones inside the mounds whose fibers dated the city; section 2 follows valley cotton into fishing nets and dried anchovies back up the valley; section 4 returns to the bags, hauled without pack animals, used to bury old rooms under new ones, and then radiocarbon-dated; section 5 meets the knotted cord on the twelfth step; and the lesson closes on the bags again, whose fiber kept its date but not a single name.
- **Memorable moments:** (1) bags of stones inside the mounds, dated to about 2627 BCE, roughly when Egypt’s first pyramid was built; (2) the mounds grew by burying their own older rooms, so each holds older versions of itself; (3) 32 small bone flutes painted red and black: the instruments survive, the songs do not; (4) a knotted cord left on the twelfth step of a pyramid stairway, which may or may not be the oldest quipu.
- **Sources of the material:** close reading of three registered sources, opened directly on 2026-09-25: the UNESCO nomination file (PDF, English text pp. 2–5, 7–8, 19–20, 24; Spanish text repeats the flute and quipu passages); Shady 2006, *Boletín de Arqueología PUCP* 10 (PDF, pp. 62–63, 77–78, 80); and the Science 2001 PubMed record (byline and abstract; the full article is paywalled). Sandweiss et al. 2009 (PNAS, via PMC) was re-read for the dry setting (“this hyperarid environment”, Earthquakes section). No new sources were needed.
- **Arithmetic:** 65 ha ÷ a 105 × 68 m pitch (0.714 ha) ≈ 91, given as “roughly the area of 90 soccer fields”.
- **Later tradition used:** none. The quipu stays a later Andean recording tradition and a contested identification.

### Changes

- Prose bodies in sections 1–5, the knowledge bodies of `module.caral.two-zones`, `module.caral.plaza-observe` and `module.caral.work-not-magic`, two `two-zones` item texts, the plaza evidence caption, the card reveal text and the `source.caral.shady-2006-pucp` use note were rewritten. All IDs, headings, module titles and eyebrows, section order, prompts, options, answer logic, prompt explanations, media, map text, scene hotspots, card facts and completion are unchanged. No module removed or reordered.
- 10 claims added to the lesson module and this note’s claim ledger: `claim.caral.dating-published-2001`, `eighteen-supe-sites`, `first-pyramid-same-era`, `fisher-farmer-exchange`, `greater-pyramid-plaza`, `unequal-tables`, `human-hauling`, `burial-and-rebuilding`, `bone-flutes`, `quipu-twelfth-step`. No sources added. Module `claimIds`/`sourceIds` updated to cover what each module now says.
- Correction carried in the voice pass: “bird-bone flutes” (no claim, no source) became “32 small bone flutes”, per the nomination file, under the new `bone-flutes` claim.
- Reading length: 1,297 → 1,654 words in the learner-facing headings, hero caption and module text (+27.5%). Prose alone grew more; the growth is the sourced detail that replaced general sentences (sizes, goods, the burial cycles, the twelfth step). Cut: the “Walk onto a dry terrace” line, the announced lesson question, the “not poured like modern concrete” opening, the summary and slogan endings, and the doubled hedges in section 5.

### Left out

- **Flute bird species.** Popular accounts say condor and pelican bone; the nomination file says only “bone”. The lesson says “bone”.
- **The 38 bone cornets** found near the same temple (nomination p. 8): popular accounts give 37. Not needed; left out.
- **The low-status diet.** Shady 2006 (p. 80) contrasts the leaders’ tables with a carbohydrate diet for the lower stratum, but the evidence given is a single sacrificed young man’s skeleton. The content triage keeps sacrifice and human remains out of this lesson, and one skeleton is thin support, so only the leaders’ tables are used.
- **Buildings that “lived in reverse”.** Shady (p. 78) reads each building’s shrinking rooms and burial as a life cycle run backwards, timed to the stars. That is the excavator’s interpretation; the lesson keeps only the observed burial and rebuilding.
- **Discovery story** (Paul Kosok’s 1948 visit; Shady’s work from 1994): reported only in encyclopedia pages, which this note does not use.
- **UNESCO list page** (`source.caral.unesco-1269`) refused automated requests (HTTP 403 from the site). Nothing new is drawn from it.

### Stage 14B check on the changed sections

| Question | Finding | Evidence and disposition |
| --- | --- | --- |
| Story | pass | Opens on the bags of stones and their date; fiber returns in sections 2 (nets, dried anchovies), 4 (bags hauled, used to bury old rooms, dated) and 5 (the knotted cord), and the ending calls back to the bags. Retellable moments: the date as old as Egypt’s first pyramid, mounds with older versions of themselves inside, 32 painted bone flutes without their songs, the cord on the twelfth step. |
| Evidence reasoning | pass | Every new detail maps to a claim with a page locator. The excavators’ exchange model and the leaders’ tables are attributed (“the excavators report”). The Egypt comparison is timing only, and section 5 still states independence. The quipu stays contested. Both prompts remain answerable from sections 1–5 unchanged. |
| Proportionality | pass | Caral is still one of many early centers; “some of its neighbors were also early” keeps the oldest-city qualifier. The excavators’ “pristine State” and “mother culture” language is not used. Inequality is shown through houses and food, without invented rulers. Ruth Shady Solís is named once, as an author of the dates, not as the memory object. |
| Cognitive load | revise → pass | New names: Shady Solís, Haas, Creamer (one sentence), Saqqara, the Greater Pyramid, the Gallery Pyramid. Numbers were trimmed to one or two per paragraph (mound height given once, the Bandurria net kept as “some at least 8 meters long” without the site name). “Amphitheater” is not used, keeping the prototype review’s decision. Length +27.5% is flagged for the owner. |
