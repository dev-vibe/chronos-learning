...
Opening orientation uses reviewed geographic data and existing chronology. A locator must place the subject relative to recognizable wider geography before asking learners to compare local sites: world/continent → recognizable region → lesson places. Supply a wider extent or linked inset and a visible native orientation sentence. Unknown local names alone are insufficient; the relationship must be readable at embedded size without opening a viewer. Maps follow the illustrated, subtle-terrain style of the early Egypt Nile map through faithful edits of real, rights-cleared geographic source images. A compact timeline relates the subject to earlier learning and meaningful overlap. Deep time, approximate dates, uncertain locations and any schematic scale are labeled honestly; do not invent precision or expose the raw graph.
...
Follow the runbook's [media method and fidelity policy](../content/lesson-creation-runbook.md#media-method-and-fidelity-policy). Prefer licensed originals for direct evidence. Deterministic/native/vector or raster methods are appropriate for factual diagrams, timelines and comparisons when they reliably preserve reviewed geometry, measurements, labels and relationships. Lesson maps use the owner-selected illustrated atlas standard in the [map runbook](../content/historical-map-production.md): subtle terrain, edited from a real geographic source, with the early Egypt Nile map as a style reference. Deterministic tools may prepare and verify those source maps and accessible overlays. Generation is also appropriate for suitable reconstruction and atmospheric art; other diagrams and evidence originals do not require stylistic transformation. Every method retains provenance, rights, uncertainty, accessible equivalents and reference/data-versus-final fidelity review.
